...
import 'package:matrixclient/modules/vwwidget/vwnodeinfoform/vwnodeinfoform.dart';
...
class VwOldFormPage extends StatefulWidget {
  VwOldFormPage(
      {super.key,
  ...
  @override
  _VwFormPageState createState() => _VwFormPageState();
}

class _VwFormPageState extends State<VwOldFormPage>
  ...
  void initState() {
    ...
    this.successMessage ="Record of "+ this.getFormName() + " is succefully saved.";
  ...
  BoxDecoration getBoxDecoration1() {
  ...
  Widget _buildPageMultipageSections(BuildContext context) {
    ...
    if ((widget.appInstanceParam.loginResponse != null &&
            ...
            widget.appInstanceParam.loginResponse!.userInfo!
                    .mainRoleUserGroup !=
                null &&
            widget.appInstanceParam.loginResponse!.userInfo!.mainRoleUserGroup!
                    .recordId ==
  ...
  Future<VwFormDefinition> _asyncLoadData() async {
      ...
      if (this.doUpsync == true) {
        ...
        if (this.currentFormDefinition.dataSource ==
          ...
          if (syncTokenBlock != null) {
            ...
            if (nodeUpsyncResultPackage.nodeUpsyncResultList.length > 0) {
              ...
              if (nodeUpsyncResult.syncResult.createdCount == 1 ||
                ...
                this.toastMessage = this.getFormName() +
                    " gagal tersinkronisasi, errorMessage: " +
            ...
            this.toastMessage = "Error: " +
                this.getFormName() +
                " gagal disinkronisasi dengan server.\n Autorisasi tidak berhasil.";
          }
        ...
        if (isSyncSuccessfull == false) {
          ...
          if (formValidationResponse == null ||
            ...
            this.toastMessage =
                "Error: Data Form gagal disimpan.\nTidak terhubung ke server";
          } else {
      ...
      if (this.doUpsync == true) {
        ...
        if (syncTokenBlock != null && syncTokenBlock.tokenList.length > 0) {
          ...
          if (widget.formResponse.syncFormResponseList != null &&
            ...
            if (nodeUpsyncResultPackage.nodeUpsyncResultList.length > 0) {
              ...
              if (nodeUpsyncResult.syncResult.createdCount == 1 ||
                ...
                this.toastBgColor = Colors.red.shade500;
                this.toastMessage =
                    "Data Verifikasi gagal disimpan, errorMessage: " +
                        nodeUpsyncResult.syncResult.errorMessage.toString();
              }
            }
          }
          ...
          if (syncTokenBlock != null &&
            ...
            this.toastMessage =
                "Error: Data Verifikasi gagal disimpan.\n Autorisasi tidak berhasil.";
          } else {
            this.toastMessage =
        ...
        if (isSyncSuccessfull == true) {
          this.toastMessage = "Data Verifikasi berhasil tersimpan";
          this.toastBgColor = Colors.green;
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<VwFormDefinition>(
        key: this.widget.key,
        future: this._asyncLoadData(),
        initialData: this.widget.formDefinition,
        builder: (context, snapshot) {
          if (snapshot.hasData == true) {
            if (this.currentState == VwFormPage.fsDataLoaded) {
              return this._buildPageMultipageSections(context);
            } else if (this.currentState == VwFormPage.errorLoadingForm) {
              return this
                  ._builReloadForm("Error : Tidak terhubung dengan server");
            } else {
              return _buildLoadingWidget("Memuat data dari server...");
            }
          } else {
            return _buildLoadingWidget("Memuat data dari server...");
          }
